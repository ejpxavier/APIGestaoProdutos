...
using APIGestaoProdutos.Utilitarios;
...
namespace APIGestaoProdutos.Contollers
{
     [Route("api/[controller]")]
     [ApiController]
     public class FornecedorController : Controller
     {
          private readonly APIGestaoProdutosDBContext _contexto;
          private readonly IConfiguration _config;

          public FornecedorController(APIGestaoProdutosDBContext contexto, IConfiguration configuration)
          {
               _contexto = contexto;
